...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .csrf().disable()
                .authorizeRequests()
                .antMatchers("api/v1/comentario/**")
                .hasAnyRole("USER", "ADMIN")
                .antMatchers("api/v1/comentario-cidade/**")
                .hasAnyRole("USER", "ADMIN")
                .antMatchers("api/v1/topico/**")
                .hasAnyRole("USER", "ADMIN")
                .antMatchers("api/v1/comentario-topico/**")
                .hasAnyRole("USER", "ADMIN")
                .antMatchers("api/v1/avaliacao-cidade/**")
                .hasAnyRole("USER", "ADMIN")
                .antMatchers("api/v1/avaliacao-topico/**")
                .hasAnyRole("USER", "ADMIN")
                .antMatchers("api/v1/estado/**")
                .hasRole("ADMIN")
                .antMatchers("api/v1/cidade/**")
                .hasAnyRole("USER", "ADMIN")
                .antMatchers("api/v1/pais/**")
                .hasRole("ADMIN")
                .antMatchers("/api/v1/avaliacao/**")
                .hasAnyRole("USER", "ADMIN")
